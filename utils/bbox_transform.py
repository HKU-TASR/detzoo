...
def bbox_transform(ex_rois, gt_rois):
    """
    Compute the transformation parameters from the predicted bounding boxes (ex_rois) to the ground truth bounding boxes (gt_rois).

    Args:
    ex_rois: Predicted bounding boxes, shape (N, 4)
